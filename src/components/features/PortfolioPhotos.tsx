          ...
          >
            ...
            {i === 8 && photos.length > 9 && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/50">
                <span className="text-lg font-black text-white">+{photos.length - 9}</span>
              </div>
            )}
          </button>
        ))}
      ...
      {isOpen &&
        ...
        createPortal(
          ...
          >
            ...
            {/* Compteur */}
            <div
              className="absolute bottom-5 left-1/2 -translate-x-1/2 rounded-full px-4 py-1 text-sm font-bold text-white/80"
            ...
            {photos.length > 1 && (
              <>
                <button
                  ...
                  className="absolute top-1/2 left-4 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border-2 border-white/40 text-2xl text-white"
                  style={{ backgroundColor: "rgba(0,0,0,0.6)" }}
                ...
                <button
                  ...
                  className="absolute top-1/2 right-4 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border-2 border-white/40 text-2xl text-white"
                  style={{ backgroundColor: "rgba(0,0,0,0.6)" }}
